...
def compute_score(sikii_list, exp_names):
...
def visualize_epoch_results(pred_tomogram_dict, base_dir, sikii_dict):
    ...
    return np.mean(scores), scores, pred_df, gt_df, pred_cls_pos, pred_Ascale_pos
