...
def read_info_json(
    base_dir="/home/tumeda/workspace/kaggle/CZII_2/20. kaggle/train/overlay/ExperimentRuns/",
    exp_name="TS_5_4",
...
class EziiDataset(Dataset):
    def __init__(
        self,
        exp_names=[],
        base_dir="/home/tumeda/workspace/kaggle/CZII_2/20. kaggle/train/static",
