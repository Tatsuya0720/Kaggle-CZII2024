...
def create_segmentation_map(tomogram, resolution, particle_coords={}):
    ...
    for particle_name, r in particle_radius.items():
        r_by_particle[particle_name] = max(2,CFG.gt_radius_ratio * r * resolution_info["A"] / resolution_info[resolution])
        # print(f"particle_name: {particle_name}, r: {r}, r_by_particle: {r_by_particle[particle_name]}")
