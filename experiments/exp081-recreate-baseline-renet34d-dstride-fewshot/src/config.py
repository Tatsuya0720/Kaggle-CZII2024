...
class CFG:
    ...
    augment_data_ratio = int(1.5*(original_img_shape[resolution][0] // slice_))
    num_workers = 16

    few_shot_epochs = 10
    few_shot_lr = 1e-5
    few_shot_train_exp_names = ["TS_73_6", "TS_99_9", "TS_6_4", "TS_69_2","TS_86_3", "TS_6_6"]
    few_shot_train_zarr_types = ["denoised"]
