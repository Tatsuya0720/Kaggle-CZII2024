...
from dataloader import drop_padding
from scipy.spatial import KDTree


def visualize_epoch_results(pred_tomogram_dict, gt_tomogram_dict, sikii_dict):
    """_summary_
    ...
    for exp_name in experiments:
        ...
        # multi-cls-pred
        # print("pred", np.array(pred_tomogram_dict[exp_name]).shape)# pred (92, 1, 7, 320, 320)
        ...
        # gt
        # print("gt", np.array(gt_tomogram_dict[exp_name]).shape) # gt (92, 1, 320, 320)
